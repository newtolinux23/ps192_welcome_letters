...
\hypersetup{
 ...
 pdftitle={P.S. 192 Family Handbook 2023-24 Org Article File},
 pdfkeywords={},
 pdfsubject={},
...
\label{sec:org4206c50}

\subsection{Looping Model}
\label{sec:orgae75532}
...
\label{sec:org03eb8d7}

\subsection{Reporting Student Progress}
\label{sec:org68d955e}
...
\label{sec:org98629f0}
\subsection{Meal Application Form}
\label{sec:org82eba20}
...
Contact our Parent Coordinator for eligibility details regarding school bus or metro card services. More info \hyperref[apendixB]{Apendix B: Transportation Eligibility}

\subsection{Wellness and Healthy Eating}
\label{sec:orgfc32e02}
...
\label{sec:org1c0814f}

\subsection{School-Wide Communication}
\label{sec:org7b0a3a1}
