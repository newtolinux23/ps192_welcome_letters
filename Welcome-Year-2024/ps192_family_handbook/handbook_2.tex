...
\fancyfoot[C]{visit www.ps192.org}
\pagestyle{fancy}
...
\label{sec:org35f06ed}

\subsection{Looping Model}
\label{sec:org90f7ed2}
...
\label{sec:org3b41118}

\subsection{Reporting Student Progress}
\label{sec:org029f4e4}
...
\label{sec:org0513f00}
\subsection{Meal Application Form}
\label{sec:org98fb134}
...
\label{sec:org5ff9f03}

\subsection{School-Wide Communication}
\label{sec:org17212c9}
